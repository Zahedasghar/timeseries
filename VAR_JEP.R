...
# save the data in data folder for docs



jep_data <- write_dta(sw_df, "C:/Users/92300/Dropbox/Applied Econometrics SBP/VAR JEP data.dta")

## Read jep_data as sw_df

sw_df <- read_dta("jep_dta")
