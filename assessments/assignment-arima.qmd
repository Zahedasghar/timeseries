...
You can find the dataset titled "data/BondReturns.csv" under the Course Resources on Black board. Please use the dataset and your own script to answer the following question:
