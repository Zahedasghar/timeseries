...
::: columns
::: {.column width="49%"}
![Constant mean?](../assets/images/paste-A7E511A8.png)
:::

::: {.column width="49%"}
![Constant variance?](../assets/images/paste-1DFA9EBF.png)
:::
:::
...
::: columns
::: {.column width="49%"} 
![stationary](../assets/images/paste-4BA97D8D.png)

:::

::: {.column width="49%"}

![non-stationary](../assets/images/paste-24AC630E.png)
...
![](../assets/images/paste-6A96C572.png)
...
![](../assets/images/paste-BE1F50D7.png)
...
![](../assets/images/paste-6268E7CF.png)
...
![](../assets/images/paste-E90AFB05.png)
...
![](../assets/images/paste-789865AE.png)

## Unit Root Testing

1\) Plot first difference of time series- Stationary

![](../assets/images/paste-545C4AD8.png)
...
Lags of the dependent variable and lags of the independent variables are included in the regression equation.
