...
![Stochastic Process vs time series](images/prob_density.png){fig-align="center"}
...
-   Two general "classes" of processes
    ...
    -   Covariance stationary:
        ...
        iii) Covariance depnds on time j that has elapsed between observations, not on reference period $Cov(Y_t,Y_{t+j})=Cov(Y_s,Y_{s+j})=\gamma_j$

## 

![Stochastic Process vs time series](images/stationary.png){fig-align="center"}
...
Moving Average : AR(process) : $y_t=\mu+u_t+\phi_1u_{t-1}+\phi_2u_{t-2}+...+\phi_qu_{t-q}+\epsilon_t$

Combined ARMA-process $y_t=a+b_1y_{t-1}+b_2y_{t-2}+...+b_py_{t-p}+u_t+\\\phi_1u_{t-1}+\phi_2u_{t-2}+...+\phi_qu_{t-q}+\epsilon_t$
