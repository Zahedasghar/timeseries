...
## SVAR Identification: recursive ordering {.scrollable}
...
-   Assuming that $u_tu_t'$ is diagonal, then 
$A^{-1}I (A^{-1})'=\Sigma_e$ same as $\Sigma_e=A^{-1}A^{-1'}$. The inverse of $A$ is lower triangular consistent with a recursive ordering.
