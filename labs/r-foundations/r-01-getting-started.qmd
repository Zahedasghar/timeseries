...
## ![R Splash Screen](../../assets/images/RSplashscreen.jpg){fig-align="center" width="1300" height="750"} {.centered .center .middle background-color="`r clrs_lt[6]`"}
...
bike <- read_csv("https://stat.duke.edu/~mc301/data/nc_bike_crash.csv")
```
