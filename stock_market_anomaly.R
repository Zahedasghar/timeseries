...
# Data
stock_data_tbl <- read_csv("https://raw.githubusercontent.com/business-science/free_r_tips/master/071_timetk_anomalize_intro/data/stock_data.csv")
stock_data_tbl |> glimpse()
