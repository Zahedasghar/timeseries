...
denmark |> colnames()
df.lev <-  df_lev <- denmark[, c("LRM", "LRY", "IBO", "IDE")]
...
dum_season$Q2 <- ifelse(substr(substr.q, 1, 1) == "2", -1/4, 0)
dum_season$Q3 <- ifelse(substr(substr.q, 1, 1) == "3", -1/4, 0)
dum_season$Q4 <- ifelse(substr(substr.q, 1, 1) == "4", -1/4, 0)
